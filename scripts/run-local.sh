...
spark-submit --master local[*] --driver-memory 24g --packages org.apache.spark:spark-avro_2.12:3.0.1 \
  --py-files $DATASETS_PROFILER_WHEEL_PATH __main__.py --parameters-path "$@" --local
