...
class ProcessorsOperationsFlags:
    ...
    string_processor_calculate_characters_entropy_is_enabled:               bool = True
    string_processor_calculate_messages_entropy_is_enabled:                 bool = True
    ...
    string_processor_get_words_length_statistics_is_enabled:                bool = True

    timestamp_processor_calculate_delta_time_in_seconds_entropy_is_enabled: bool = True
